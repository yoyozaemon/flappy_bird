...
impl GameScene {
    pub fn new(ctx: &mut Context) -> tetra::Result<GameScene> {
        ...
        Ok(GameScene {
            ...
            bird,
            flap_sound: Sound::new("./resources/audio/flap.wav")?,
            ground_hit_sound: Sound::new("./resources/audio/ground-hit.wav")?,
            pipe_hit_sound: Sound::new("./resources/audio/pipe-hit.wav")?,
            score_sound: Sound::new("./resources/audio/score.wav")?,
            score: 0,
